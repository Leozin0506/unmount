  ...
  async addStory() {
    if(this.state.title &&
      ...
      this.state.moral){
        ...
        Alert.alert("error","todos os campos são obrigatorios",
        [{text:"ok",onPress:()=>console.log("ok pressionado")}],{cancelable:false});
      }
  }
        ...
        >
          ...
          <View style={styles.fieldsContainer}>
            <ScrollView>
              ...
              <View>
                <Button
                title="Enviar" color="#841584" onPress={()=>this.addStory()}
                />
              </View>
            </ScrollView>
          </View>
